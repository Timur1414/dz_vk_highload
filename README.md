...
В 2018 году компания мигрировала на Google Cloud Platform [22]. После этого Spotify имеет дата-центры в 5 регионах:
europe-west1 (Сен-Гислен, Бельгия), us-central1 (Каунсил-Блафс, Айова), asia-east1 (Тайвань), us-east1 (Монкс-Корнер, Южная Каролина), europe-west4 (Эмсхавен, Нидерланды) [23].
...
RTT до ключевых европейских столиц составляет всего 5-15 мс.
RTT до Нью-Йорка, Вашингтона, Торонто и Майами ≤ 20 мс.
RTT в любую точку континентальной части США не превышает 25-30 мс.
